/**
 * This script defines and manages annotations for a 3D scene using the Potree library.
 * 
...
function createIconElement(iconName, actionName, invert = false) {
    ...
    return `<img src="./libs/potree/resources/icons/${iconName}.svg" name="${actionName}" class="annotation-action-icon" ${style ? `style="${style}"` : ''}/>`;
}
...
const annotationConfigs = [
    {
        ...
        actions: [{
            ...
            handler: () => {
                ...
                setAnnotationsVisibility({ 3: false, 4: false, 5: false, 6: false, 7: false, 8: false, 9: false, 10: false, 11: false, 12: false });
            }
        }]
    },
    {
        ...
        actions: [
            ...
            },
            {
                ...
                handler: (event) => {
                    ...
                    setAnnotationsVisibility({ 0: false, 1: false, 2: false, 3: true, 4: true, 5: true, 6: true, 7: true, 8: false, 9: false, 10: false, 11: false, 12: false, 13: false, 14: false, 15: true, 16: true });
                }
            }
        ]
    },
    {
        ...
        visible: false,
        customTitle: '<span>Start exploring! <input type="button" name="outdoor" value="Go back outdoor!"/></span>',
        customHandler: (titleElement) => {
            titleElement.find("input[name=outdoor]").click((event) => {
                ...
                setAnnotationsVisibility({ 0: true, 1: true, 2: true, 3: false, 4: false, 5: false, 6: false, 7: false, 8: false, 9: false, 10: false, 11: false, 12: false, 13: false, 14: false, 15: false, 16: false });
            });
        }
    },
    {
        ...
        actions: [{
            ...
            handler: (event) => {
                event.stopPropagation();
                animation.play();
                setAnnotationsVisibility({ 8: true, 9: true, 10: true, 11: true, 13: true });
            }
        }]
    },
    {
...
const imageAnnotations = [
    { id: 'anno1', name: 'Plastico Piacenza', position: [553468.241, 4988914.587, 96.098], cameraPosition: [553469.8194153706, 4988913.956457145, 97.93433745029579], cameraTarget: [553469.779872537, 4988913.96702074, 97.87532042534758], description: '<b>Old Piacenza City Model</b><br>----<br>The model reconstruct the situation of the Piacenza city in the first half of the XVI century. The river Po visible in the bottom part of the picture indicates the geographical north. The 6 km-long urban walls were built by the will of Pope Clemente VII at the beginning of that century to reinforce the city defense system.<br>----<br><img src="assets/anno-img/piacenza-plastico.jpg" alt="Old Piacenza Plastico" title="Old Piacenza Plastico" width="270px">', visible: false, index: 6 },
    { id: 'anno2', name: 'Old map of Piacenza', position: [553469.053, 4988920.173, 96.870], cameraPosition: [553471.1851376052, 4988920.489146103, 97.20975445747173], cameraTarget: [553470.2150590685, 4988920.39096358, 96.99985462186642], description: '<b>Old Piacenza Map</b><br>----<br>The map illustrates the city plan in the XVI century. In the upper right portion it is visible the Farnese castle with its peculiar pentagonal plan. The map clearly shows how its external rampart walls were part of the enceinte of the city, already existent before the construction of the castle.<br>----<br><img src="assets/anno-img/piacenza-map.jpg" alt="Old Piacenza Map" title="Old Piacenza Map" width="270px">', visible: false, index: 7 },
    { id: 'anno3', name: 'Armor 1', position: [553467.122, 4988906.703, 96.305], cameraPosition: [553465.5320448811, 4988908.552441066, 97.55644288528843], cameraTarget: [553467.3375243957, 4988906.725013733, 96.24520099166907], description: '<b>Armor</b><br>----<br><img src="assets/anno-img/armor1.jpg" alt="Medieval armor" title="Medieval Armor" width="270px">', visible: false, index: 8 },
    { id: 'anno4', name: 'Armor 2', position: [553464.626, 4988905.101, 96.204], cameraPosition: [553463.4076802338, 4988907.264894535, 96.3396021385902], cameraTarget: [553463.9388958209, 4988906.130368572, 96.05896626293325], description: '<b>Armor</b><br>----<br><img src="assets/anno-img/armor2.jpg" alt="Medieval armor" title="Medieval Armor" width="270px">', visible: false, index: 9, opacity: 0.2 },
    { id: 'anno5', name: 'Armor 3', position: [553462.022, 4988903.801, 96.413], cameraPosition: [553461.0117883002, 4988905.83894213, 96.30264985111171], cameraTarget: [553461.660989483, 4988904.760987417, 96.04839188043876], description: '<b>Armor</b><br>----<br><img src="assets/anno-img/armor3.jpg" alt="Medieval armor" title="Medieval Armor" width="270px">', visible: false, index: 10, opacity: 0.2 },
    { id: 'anno6', name: 'Plastico Castello', position: [553452.063, 4988908.686, 95.781], cameraPosition: [553452.8222248793, 4988906.980127202, 97.1850908613455], cameraTarget: [553452.2814114128, 4988908.670055407, 95.68378200038859], description: '<b>Old Piacenza Citadel Model</b><br>----<br>The model reconstructs the original structure of the castle commissioned by Pier Luigi Farnese in the XVI century. The 3 surveyed bastions are visible in the upper part of the picture, corresponding to the southernmost area of Piacenza. The buildings inside the walls are part of the pre-existing monastery of St. Benedict, destroyed by an explosion in 1805 when the Farnese castle complex was used as a weapons and powder store for military artillery. <br>----<br><img src="assets/anno-img/castello-plastico.jpg" alt="Plastico castello" title="Plastico castello" width="270px">', visible: false, index: 11, opacity: 0.2 },
    { id: 'anno7', name: 'San Giacomo Bastion Dungeons', position: [553470.263, 4988927.862, 94.700], cameraPosition: [553467.7806220746, 4988926.3230987545, 95.9174366691439], cameraTarget: [553468.8885795458, 4988926.818049205, 95.80151137015869], description: '<b>San Giacomo Bastion Dungeons</b><br>----<br><img src="assets/anno-img/sotterranei.jpg" alt="Sotterranei" title="Sotterranei" width="270px">', visible: false, index: 12, opacity: 0.2 },
    { id: 'anno8', name: 'Paolo II print', position: [553468.173, 4988913.334, 96.274], cameraPosition: [553470.5484979739, 4988913.944287285, 97.04518532773058], cameraTarget: [553468.173, 4988913.334, 96.274], description: '<b>Paolo II print</b><br>----<br>The Pope is shown seated and flanked by Cardinal Alessandro Farnese as he approves the plan of the castle of Piacenza. The plan is presented to him by Pierluigi, who is kneeling, and is dressed in yellow and blue and has a white mantle. Architecture can be glimpsed in the background.<br>Original paint from 1685 - 1687 by Sebastiano Ricci, preserved at the Civic Museum of the Farnese Palace (Piacenza).<br>----<br><img src="assets/anno-img/paoloIII.jpg" alt="Paolo III Print" title="Paolo III Print" width="270px">', visible: false, index: 15, opacity: 0.2 },
    { id: 'anno9', name: 'Pier Luigi Farnese print', position: [553468.945, 4988915.666, 96.280], cameraPosition: [553470.1248426964, 4988913.89451259, 96.98269181617856], cameraTarget: [553468.945, 4988915.666, 96.280], description: '<b>Pier Luigi Farnese print</b><br>----<br>The pope is shown seated and covered in a green and gold mantle while receiving Pier Luigi, dressed in yellow and covered in a blue mantle. Surrounding are cardinals and noble figures, two of whom are holding a crown. The pope is seated under a red canopy.<br>Original paint from 1685 - 1687 by Sebastiano Ricci, preserved at the Civic Museum of the Farnese Palace (Piacenza).<br>----<br><img src="assets/anno-img/pierluigifarnese.jpg" alt="Pierluigi Farnese Print" title="Pierluigi Farnese Print" width="270px">', visible: false, index: 16, opacity: 0.2 }
];
...
const navigationAnnotations = [
    {
        ...
        actions: [{
            ...
            handler: (event) => {
                event.stopPropagation();
                scenears.annotations.children[3].moveHere(scenears.camera);
                setAnnotationsVisibility({ 8: false, 9: false, 10: false, 11: false, 13: false });
            }
        }]
    },
    {
...
function createAnnotation(config) {
    ...
    if (config.customTitle) {
        ...
        const icons = config.actions?.map(action => 
        ...
        config.actions?.forEach((action, idx) => {
            titleElement.find(`img[name=action_${action.icon}]`).click(action.handler);
        });
    }
...
function createImageAnnotation(config) {
    const titleElement = $(`<span>${createIconElement('orbit_controls', `anno_panel_${config.id}`)}</span>`);
...
function loadAllAnnotations() {
    ...
    console.log(`Loaded ${annotationConfigs.length + imageAnnotations.length + navigationAnnotations.length} annotations`);
}
